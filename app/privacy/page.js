...
export const metadata = {
    title: "Privacy Policy | Applex Electronics",
    description: "Applex Electronics privacy policy — how we collect, use, and protect your personal information.",
};
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-6">
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                    <p className="text-sm text-gray-600 leading-relaxed mb-8">
                        At Applex Electronics, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.
                    </p>
                    ...
                    <div className="mt-10 p-5 bg-gray-50 rounded-xl border border-gray-100">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="/" className="text-brand-purple font-semibold hover:underline">support@applex.com</a> or call{" "}
