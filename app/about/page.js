...
export const metadata = {
    title: 'About Us | Applex Electronics',
    description: 'Learn about Applex Electronics — Bangladesh\'s premier destination for genuine tech gear, smart gadgets, and digital lifestyle accessories.',
};
        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="bg-gradient-to-br from-brand-purple/10 via-purple-50 to-white py-16 md:py-24">
                <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">About <span className="text-brand-purple">Applex Electronics</span></h1>
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16 space-y-12">
                <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        Applex Electronics is a leading electronics and gadget retailer in Bangladesh. We are passionate about bringing the latest technology to your doorstep at the most competitive prices. From smartphones and laptops to accessories and smart home devices, we curate only the best products from top global brands.
                    </p>
                </section>
