    ...
    return (
        <section className="w-full bg-white py-12 md:py-16">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                <div className="relative rounded-3xl overflow-hidden bg-blue-50 border border-blue-100">
                    ...
                    <div className="relative z-10 p-8 md:p-16 flex flex-col items-center text-center">
                        ...
                        <form className="w-full max-w-md flex flex-col sm:flex-row gap-3">
                            <input
                                ...
                                className="flex-1 px-6 py-4 rounded-full bg-white border border-gray-200 text-gray-900 placeholder:text-gray-400 outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-600/20 transition-all font-medium shadow-sm"
                                required
                            />
                            <button
                                type="submit"
                                className="px-8 py-4 rounded-full bg-blue-600 text-white font-bold hover:bg-blue-700 transition-colors shadow-md whitespace-nowrap"
                            >
                                Subscribe Now
                            </button>
                        </form>
