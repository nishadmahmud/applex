...
import { FaFacebook, FaInstagram, FaYoutube, FaTiktok, FaCcVisa, FaCcMastercard, FaCcPaypal, FaApplePay } from 'react-icons/fa';
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 justify-between lg:grid-cols-5 gap-8 md:gap-10">
                        ...
                        <div className="lg:col-span-2 flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-3 text-[13px] mt-2">
                                <p><strong className="text-white">Phone:</strong> 01980-803060</p>
                                <p><strong className="text-white">Address:</strong> Shop: 4D-018B1, Block D, Level 4, Jamuna Future Park, Dhaka, Bangladesh, 1229</p>
                            </div>
                            <div className="flex gap-3 mt-2">
                                <a href="https://web.facebook.com/Applex.bd" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-blue-600 transition-colors"><FaFacebook size={14} /></a>
                                <a href="https://www.tiktok.com/@applexofficialbd" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-[#ff0050] transition-colors"><FaTiktok size={14} /></a>
                                <a href="https://www.youtube.com/@user-lh5pe6ug2b" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-[#ff0000] transition-colors"><FaYoutube size={14} /></a>
                            </div>
                        </div>
            ...
            <div className="bg-[#030712]">
                <div className="max-w-7xl mx-auto px-4 md:px-8 py-5 text-center">
                    <div className="text-[11px] text-gray-600 font-medium">
                        <p>&copy; {new Date().getFullYear()} Applex Ltd. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
